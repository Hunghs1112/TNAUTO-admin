  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-2 backdrop-blur-sm sm:p-4">
      <div className="flex max-h-[95vh] w-full max-w-5xl flex-col rounded-xl border border-gray-200/50 bg-white shadow-2xl dark:border-slate-700/50 dark:bg-slate-800">
        <div className="gradient-header flex flex-shrink-0 items-start justify-between border-b border-gray-200 p-4 transition-colors duration-300 dark:border-slate-700 sm:p-6">
          <div>
            ...
            {selectedProduct && (
              <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">{selectedProduct.name}</p>
            )}
          </div>
          <button
            onClick={onClose}
            className="rounded-lg p-2 text-gray-400 transition-all duration-200 hover:bg-gray-100 hover:text-gray-600 dark:text-gray-500 dark:hover:bg-slate-700 dark:hover:text-gray-300"
            aria-label="Đóng"
          >
            <X size={20} />
          </button>
            ...
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-slate-600 dark:bg-slate-700/50">
              ...
              {isEditMode ? (
                ...
                <div className="grid grid-cols-1 gap-3 text-sm sm:grid-cols-2">
                  <div>
                    <span className="font-medium text-gray-700 dark:text-gray-300">Tên:</span>{' '}
                    <span className="text-gray-900 dark:text-gray-100">{selectedProduct.name || '-'}</span>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <span className="text-gray-900 dark:text-gray-100">{selectedProduct.category_name || '-'}</span>
                  </div>
                  {selectedProduct.description && (
                    <div className="sm:col-span-2">
                      <span className="font-medium text-gray-700 dark:text-gray-300">Mô tả:</span>{' '}
            ...
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-slate-600 dark:bg-slate-700/50">
              ...
              {isEditMode ? (
                <div className="space-y-3">
                  ...
                  {formData.video_url && (
                    <div className="mt-3">
                      <p className="mb-2 text-xs font-medium text-gray-700 dark:text-gray-300">Xem trước:</p>
                ...
                <div className="py-4 text-center text-gray-500 dark:text-gray-400">Chưa có video nào</div>
              )}
            </div>
