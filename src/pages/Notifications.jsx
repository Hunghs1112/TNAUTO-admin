...
export default function Notifications() {
  ...
  const handleMarkAllRead = async () => {
    ...
    try {
      const res = await notificationsAPI.markAllRead(filters.recipient_id, filters.recipient_type);
      alert(`Đã đánh dấu ${res.data.updated_count || 0} thông báo là đã đọc`);
      fetchData();
    } catch (err) {
  ...
  const handleSendNotification = async () => {
    ...
    try {
      ...
      const res = await notificationsAPI.send({
        ...
        send_push: false // Không dùng send_push của backend
      });
        ...
        try {
          const pushRes = await pushNotificationsAPI.sendToUser({
            ...
            notification: {
              ...
              ...(sendForm.image_url && { imageUrl: sendForm.image_url })
            },
            data: {
              type: 'custom_notification',
              notification_id: String(notificationId) // ← Convert to string for FCM
            }
          });
      ...
      {permissionStatus !== 'granted' && permissionStatus !== 'not-supported' && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start gap-3">
          ...
          <div className="flex-1">
            <h3 className="font-semibold text-blue-900 mb-1">Bật thông báo push realtime</h3>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        {filters.recipient_id && filters.recipient_type && (
          <button
            ...
            className={`${buttonStyles.success} flex items-center gap-2`}
          >
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={sendForm.image_url}
                    onChange={(e) => setSendForm({ ...sendForm, image_url: e.target.value })}
                ...
                <div className="flex items-center gap-2">
                  ...
                  />
                  <label htmlFor="send-push-checkbox" className="text-sm font-medium text-gray-700">
