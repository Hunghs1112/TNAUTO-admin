...
const vehicleFormFields = [
  ...
  { name: 'license_section', label: 'Bằng lái xe', type: 'section' },
  { name: 'license_number', label: 'Số bằng lái xe', type: 'text' },
  { name: 'license_expiry_date', label: 'Ngày hết hạn bằng lái', type: 'date', required: true },
  { name: 'inspection_section', label: 'Đăng kiểm', type: 'section' },
  { name: 'inspection_certificate_number', label: 'Số chứng nhận đăng kiểm', type: 'text', required: true },
  { name: 'inspection_date', label: 'Ngày đăng kiểm', type: 'date', required: true },
  { name: 'inspection_expiry_date', label: 'Ngày hết hạn đăng kiểm', type: 'date', required: true },
  { name: 'insurance_section', label: 'Bảo hiểm', type: 'section' },
  { name: 'insurance_company', label: 'Đơn vị bảo hiểm', type: 'text', required: true },
  { name: 'insurance_start_date', label: 'Ngày bắt đầu bảo hiểm', type: 'date', required: true },
  { name: 'insurance_expiry_date', label: 'Ngày hết hạn bảo hiểm', type: 'date', required: true },
];
